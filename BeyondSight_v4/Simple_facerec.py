...
class SimpleFacerec:
    ...
    def _process_image(self, img_path):
        """Helper function to process an image and extract face encodings."""
    ...
    def load_encoding_images(self, images_path, encodings_file='encodings.pkl'):
        ...
        if os.path.exists(encodings_file):
            ...
            with ThreadPoolExecutor() as executor:
                results = executor.map(self._process_image, image_files)

            for img_encoding, filename in results:
